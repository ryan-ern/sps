<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        <i class="icon icon-shape icon-sm fas fa-times px-0 text-center d-flex align-items-center justify-content-center cursor-pointer text-white position-absolute end-0 top-0 d-none d-xl-none"
