<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href=" {{ route('dashboard') }}" target="_blank">
            ...
            <span class="text-wrap mx-3">Perpustakaan Digital SMP Negeri 1 Sidomulyo</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4 mt-3 w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (auth()->user()->role == 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ is_current_route('pustaka.read') ? 'active' : '' }}"
                        href="{{ route('pustaka.read') }}">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="14" width="15.75"
                                viewBox="0 0 576 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            @elseif(auth()->user()->role == 'guru')
                <li class="nav-item">
                    <a class="nav-link  {{ is_current_route('konten-digital.read') ? 'active' : '' }}"
                        href="{{ route('konten-digital.read') }}">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="14" width="12.25"
                                viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        ...
                        <span class="nav-link-text ms-1">Konten Digital</span>
                    </a>
                </li>
            @else
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ is_current_route('profil.read') ? 'active' : '' }}"
                        href="{{ route('profil.read') }}">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="14" width="15.75"
                                viewBox="0 0 576 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
